...
public class MediaElement : View, IMediaElement, IDisposable
{
	...
	/// </summary>
	public static readonly BindableProperty MetadataArtworkUrlProperty = BindableProperty.Create(nameof(MetadataArtworkUrl), typeof(MediaSource), typeof(MediaElement), null);
